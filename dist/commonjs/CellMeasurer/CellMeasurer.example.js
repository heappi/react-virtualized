...
var _CellMeasurerExample2 = _interopRequireDefault(
...
var CellMeasurerExample = (exports['default'] = /*#__PURE__*/ (function(
...
function getClassName(_ref2) {
  ...
  var rowClass =
    rowIndex % 2 === 0
      ? _CellMeasurerExample2['default'].evenRow
      : _CellMeasurerExample2['default'].oddRow;
  return (0, _clsx3['default'])(
    rowClass,
    _CellMeasurerExample2['default'].cell,
    (0, _defineProperty2['default'])(
      {},
      _CellMeasurerExample2['default'].centeredCell,
      columnIndex > 2,
    ),
  );
}
...
function Tab(_ref4) {
  ...
  var classNames = (0, _clsx3['default'])(
    _CellMeasurerExample2['default'].Tab,
    (0, _defineProperty2['default'])(
      {},
      _CellMeasurerExample2['default'].ActiveTab,
      currentTab === id,
    ),
  );
  return /*#__PURE__*/ React.createElement(
